...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    const [products, setProducts] = useLocalStorage<Product[]>('medusa_products', demoProducts);
    const [mainCategories, setMainCategories] = useLocalStorage<MainCategory[]>('medusa_main_categories', demoMainCategories);
    const [subcategories, setSubcategories] = useLocalStorage<Subcategory[]>('medusa_subcategories', demoSubcategories);
    const [orders, setOrders] = useLocalStorage<Order[]>('medusa_orders', demoOrders);
